...
describe('Stats', () => {
  ...
  it('Downloads single game', async () => {
    mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadSingleLog }))
  ...
  it('Downloads multiple games', async () => {
    mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadMultipleLog }))
    const stats = await parseLogFile()
  ...
  it('Downloads and reuse', async () => {
    mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadAndReuseLog }))
    const stats = await parseLogFile()
    expect(stats.bytesDownloaded).toEqual(3000)
  ...
  it('Reuse multiple', async () => {
    mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => reuseMultiple }))
    const stats = await parseLogFile()
    expect(stats.bytesDownloaded).toEqual(3000)
  ...
  it('Mixes downloads', async () => {
    mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadMixed }))
    const stats = await parseLogFile()
    expect(stats.downloads.length).toEqual(2)
  })

  it.skip('Delete Reuse', async () => {
    mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => reuseMultiple }))
    const stats = await parseLogFile()
  ...
  describe.skip('Delete app', () => {
    it('Delete epic games', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteEpic }))
      const stats = await parseLogFile()
    ...
    it('Delete steam', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteSteam }))
      const stats = await parseLogFile()
    ...
    it('Delete steam with 0 bytes', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteSteamZeroBytes }))
      const stats = await parseLogFile()
    ...
    it('Delete battlenet', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteBlizzard }))
      const stats = await parseLogFile()
    ...
    it('Delete riot', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteRiot }))
      const stats = await parseLogFile()
    ...
    it('Delete app with multiple app logs', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteMultiple }))
      const stats = await parseLogFile()
    ...
    it('Delete windows', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => deleteWindows }))
      const stats = await parseLogFile()
  ...
  describe('Epic', () => {
    ...
    it('Game Download', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadEpic }))
      const stats = await parseLogFile()
    ...
    it('Game Reuse', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => reuseEpic }))
      const stats = await parseLogFile()
  ...
  describe('Battlenet', () => {
    ...
    it('Game Download', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadBattlenet }))
      const stats = await parseLogFile()
      expect(stats.downloads.length).toBe(1)
      expect(stats.downloads[0].bytesDownloaded).toBe(3000)
    ...
    it('Game Reuse', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => reuseBattlenet }))
      const stats = await parseLogFile()
      expect(stats.reuses.length).toBe(1)
      expect(stats.reuses[0].bytesDownloaded).toBe(3000)
  ...
  describe('Riot', () => {
    it('Game Download', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadRiot }))
      const stats = await parseLogFile()
      expect(stats.downloads.length).toBe(1)
    ...
    it('Game Reuse', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => reuseRiot }))
      const stats = await parseLogFile()
      expect(stats.reuses.length).toBe(1)
  ...
  describe('Windows', () => {
    it('Download Windows', async () => {
      mock.module('../src/routes/stats.ts', () => ({ getLogPath: () => downloadWindows }))
      const stats = await parseLogFile()
